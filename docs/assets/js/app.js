...
},{"gsap/TweenLite":331}],331:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.20.2
 * DATE: 2017-06-30
...
require("./core/threejs/orbit-controls");
...
var _progressScrollbar = require("./components/progress-scrollbar/progress-scrollbar");

var _codepen = require("./components/codepen/codepen");

var _progressLinear = require("./components/progress-linear/progress-linear");

var _works = require("./sections/works/works");

var _lab = require("./sections/lab-001/lab-001");

var _lab2 = require("./sections/lab-002/lab-002");

var _services = require("./core/services");

var _webaudio = require("./services/webaudio");
...
*/
var App = (_dec = (0, _services.Services)([_webaudio.WebAudio]), _dec(_class = function (_HTMLElement) {
    ...
    _createClass(App, [{
        ...
        value: function createdCallback() {
            ...
            // components
            document.registerElement(App.PREFIX + "hero", _hero.Hero);
            document.registerElement(App.PREFIX + "button", _button.Button);
            document.registerElement(App.PREFIX + "section", _section.Section);
            document.registerElement(App.PREFIX + "progress-scrollbar", _progressScrollbar.ProgressScrollbar);
            document.registerElement(App.PREFIX + "codepen", _codepen.Codepen);
            document.registerElement(App.PREFIX + "progress-linear", _progressLinear.ProgressLinear);

            // sections
            document.registerElement(App.PREFIX + "works", _works.Works);
            document.registerElement(App.PREFIX + "lab-001", _lab.Lab001);
            document.registerElement(App.PREFIX + "lab-002", _lab2.Lab002);
            ...
            var sections = Array.from(this.querySelectorAll('vp-section'));
            sections.map(function (section) {
                return _this2.tl.add(section.animation);
            });
        ...
        value: function scroll(event) {
            var percent = window.scrollY / (document.body.clientHeight - window.innerHeight);
...
},{"./components/button/button":335,"./components/codepen/codepen":336,"./components/hero/hero":337,"./components/progress-linear/progress-linear":338,"./components/progress-scrollbar/progress-scrollbar":339,"./components/section/section":340,"./core/events/event":344,"./core/services":345,"./core/threejs/orbit-controls":347,"./sections/lab-001/lab-001":348,"./sections/lab-002/lab-002":349,"./sections/works/works":350,"./services/webaudio":351,"babel-polyfill":1,"document-register-element":329,"gsap/src/uncompressed/TimelineMax":330,"gsap/src/uncompressed/TweenMax":332,"whatwg-fetch":333}],335:[function(require,module,exports){
'use strict';
...
},{"../../core/base-component":342}],336:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Codepen = undefined;
...
var Codepen = exports.Codepen = function (_BaseComponent) {
    _inherits(Codepen, _BaseComponent);
    ...
    _createClass(Codepen, [{
        key: 'createdCallback',
        value: function createdCallback() {
            _get(Codepen.prototype.__proto__ || Object.getPrototypeOf(Codepen.prototype), 'createdCallback', this).call(this);
...
},{"../../core/base-component":342}],337:[function(require,module,exports){
'use strict';
...
var Hero = exports.Hero = (_dec = (0, _services.Services)([_webaudio.WebAudio]), _dec(_class = function (_BaseComponent) {
    _inherits(Hero, _BaseComponent);
    ...
    _createClass(Hero, [{
        key: 'createdCallback',
        value: function createdCallback() {
            _get(Hero.prototype.__proto__ || Object.getPrototypeOf(Hero.prototype), 'createdCallback', this).call(this);
            ...
            this.webaudio.on(_webaudio.WebAudio.RENDER, this.render.bind(this));
        }
    }, {
        key: 'render',
        value: function render(event) {
            var frequencyData = event.frequencyData;
    ...
    return Hero;
}(_baseComponent.BaseComponent)) || _class);

},{"../../core/base-component":342,"../../core/services":345,"../../services/webaudio":351}],338:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ProgressLinear = undefined;
...
var ProgressLinear = exports.ProgressLinear = function (_BaseComponent) {
    _inherits(ProgressLinear, _BaseComponent);

    function ProgressLinear() {
        _classCallCheck(this, ProgressLinear);

        return _possibleConstructorReturn(this, (ProgressLinear.__proto__ || Object.getPrototypeOf(ProgressLinear)).call(this));
    }
    ...
    _createClass(ProgressLinear, [{
        key: 'createdCallback',
        value: function createdCallback() {
            _get(ProgressLinear.prototype.__proto__ || Object.getPrototypeOf(ProgressLinear.prototype), 'createdCallback', this).call(this);
        }
    }]);
...
},{"../../core/base-component":342}],339:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ProgressScrollbar = undefined;
...
var ProgressScrollbar = exports.ProgressScrollbar = function (_BaseComponent) {
    _inherits(ProgressScrollbar, _BaseComponent);

    function ProgressScrollbar() {
        _classCallCheck(this, ProgressScrollbar);

        return _possibleConstructorReturn(this, (ProgressScrollbar.__proto__ || Object.getPrototypeOf(ProgressScrollbar)).call(this));
    }
    ...
    _createClass(ProgressScrollbar, [{
        key: 'createdCallback',
        value: function createdCallback() {
            _get(ProgressScrollbar.prototype.__proto__ || Object.getPrototypeOf(ProgressScrollbar.prototype), 'createdCallback', this).call(this);
            this.resume();
        }
    }, {
        key: 'scroll',
    ...
    return ProgressScrollbar;
}(_baseComponent.BaseComponent);

},{"../../core/base-component":342}],340:[function(require,module,exports){
"use strict";
...
var Section = exports.Section = function (_BaseComponent) {
    _inherits(Section, _BaseComponent);
    ...
    _createClass(Section, [{
        ...
        value: function createdCallback() {
            ...
            _get(Section.prototype.__proto__ || Object.getPrototypeOf(Section.prototype), "createdCallback", this).call(this);
        }
    }, {
        key: "animation",
        get: function get() {
            var anim = new TweenMax(this, 2, {
                delay: 1,
                y: 0,
                rotationX: "0deg",
                ease: Cubic.easeOut
...
},{"../../core/base-component":342}],341:[function(require,module,exports){
"use strict";
...
},{"./events/event":344}],343:[function(require,module,exports){
"use strict";
...
function Services(services) {
    return function (target) {
        if (services) target.prototype.services = (0, _helpers.buildDependencies)(target, services);
    };
}

},{"./_helpers":341}],346:[function(require,module,exports){
'use strict';
...
var Lab001 = exports.Lab001 = function (_BaseComponent) {
    _inherits(Lab001, _BaseComponent);

    function Lab001() {
        _classCallCheck(this, Lab001);

        return _possibleConstructorReturn(this, (Lab001.__proto__ || Object.getPrototypeOf(Lab001)).call(this));
    }
    ...
    _createClass(Lab001, [{
        ...
        value: function createdCallback() {
            ...
            _get(Lab001.prototype.__proto__ || Object.getPrototypeOf(Lab001.prototype), 'createdCallback', this).call(this);
        }
    }, {
        key: 'over',
        ...
        value: function move(event) {
            event.preventDefault();
            var mx = (event.clientX || event.targetTouches[0].clientX) - this.thumbnailEl.offsetLeft;
            var my = (event.clientY || event.targetTouches[0].clientY) - this.thumbnailEl.offsetTop;
            var px = (mx - this.thumbnailEl.clientWidth / 2) / (this.thumbnailEl.clientWidth / 2);
            var py = (my - this.thumbnailEl.clientHeight / 2) / (this.thumbnailEl.clientHeight / 2);
            var angle = 10;
            var offsetX = 20;
            var offsetY = 10;
...
},{"../../core/base-component":342}],349:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Lab002 = undefined;
...
var Lab002 = exports.Lab002 = (_dec = (0, _services.Services)([_webaudio.WebAudio]), _dec(_class = function (_BaseComponent) {
    _inherits(Lab002, _BaseComponent);

    function Lab002() {
        _classCallCheck(this, Lab002);

        return _possibleConstructorReturn(this, (Lab002.__proto__ || Object.getPrototypeOf(Lab002)).call(this));
    }
    ...
    _createClass(Lab002, [{
        ...
        value: function createdCallback() {
            ...
            _get(Lab002.prototype.__proto__ || Object.getPrototypeOf(Lab002.prototype), 'createdCallback', this).call(this);
        }
    }, {
        key: 'build',
        value: function build() {
            ...
            while (i < 20) {
                ...
                var cubeMaterial = new THREE.MeshLambertMaterial({ color: 0x33ff00 });
...
},{"../../core/base-component":342,"../../core/services":345,"../../services/webaudio":351}],350:[function(require,module,exports){
'use strict';
...
var Works = exports.Works = function (_BaseComponent) {
    _inherits(Works, _BaseComponent);

    function Works() {
        _classCallCheck(this, Works);

        return _possibleConstructorReturn(this, (Works.__proto__ || Object.getPrototypeOf(Works)).call(this));
    }
    ...
    _createClass(Works, [{
        key: 'createdCallback',
        value: function createdCallback() {
            _get(Works.prototype.__proto__ || Object.getPrototypeOf(Works.prototype), 'createdCallback', this).call(this);
        }
    }]);
...
},{"../../core/base-component":342}],351:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.WebAudio = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _dec, _class; // third-party


var _singleton = require('../core/singleton');
 ...
 * WebAudio
 */
var WebAudio = exports.WebAudio = (_dec = (0, _singleton.Singleton)({
    name: 'webaudio'
}), (0, _emitter.Emitter)(_class = _dec(_class = function () {
    _createClass(WebAudio, null, [{
        key: 'RENDER',
        get: function get() {
            return 'webaudio-render';
        }
    ...
    _createClass(WebAudio, [{
        ...
        value: function load() {
            ...
            var url = 'assets/audios/arctic-monkeys-the-view-from-the-afternoon.mp3';
            var options = {
                method: 'GET',
                mode: 'cors',
                cache: 'default'
            ...
            fetch(url, options).catch(function (err) {
                ...
                return _this.context.decodeAudioData(buffer).then(_this.audioLoaded.bind(_this));
            });
        }
    }, {
        key: 'audioLoaded',
        value: function audioLoaded(audioBuffer) {
...
},{"../core/emitter":343,"../core/singleton":346}]},{},[334]);
